...
public class RandomGoodEffect extends MobEffect {
    public static int color = -16777012;
    public RandomGoodEffect(MobEffectCategory mobEffectCategory) {
        super(MobEffectCategory.BENEFICIAL, color);
    }

    @Override
    public String getDescriptionId() {
        return "effect.jigsaw_pp.random_good_effect";
    }
