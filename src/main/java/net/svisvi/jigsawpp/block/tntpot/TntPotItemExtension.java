...
public class TntPotItemExtension {
    @SubscribeEvent
    public static void init(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> DispenserBlock.registerBehavior(ModBlocks.TNTPOT.get(), new DefaultDispenseItemBehavior() {
            protected ItemStack execute(BlockSource p_123425_, ItemStack p_123426_) {
                ...
                PrimedTntPot primedtnt = new PrimedTntPot(level, (double)blockpos.getX() + 0.5, (double)blockpos.getY(), (double)blockpos.getZ() + 0.5, (LivingEntity)null);
