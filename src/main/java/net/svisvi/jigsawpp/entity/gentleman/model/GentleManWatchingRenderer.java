...
public class GentleManWatchingRenderer extends AbstractGentleManWatchingRenderer<GentleManWatchingEntity, GentlemanModel<GentleManWatchingEntity>> {

    public GentleManWatchingRenderer(EntityRendererProvider.Context context) {
        this(context, ModelLayers.ZOMBIE, ModelLayers.ZOMBIE_INNER_ARMOR, ModelLayers.ZOMBIE_OUTER_ARMOR);
    }

    public GentleManWatchingRenderer(EntityRendererProvider.Context pContext, ModelLayerLocation pZombieLayer, ModelLayerLocation pInnerArmor, ModelLayerLocation pOuterArmor) {
