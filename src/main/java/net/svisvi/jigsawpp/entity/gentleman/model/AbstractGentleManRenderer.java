...
public abstract class AbstractGentleManRenderer <T extends GentleManEntity, M extends GentlemanModel<T>> extends HumanoidMobRenderer<T, M> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(JigsawPpMod.MODID,"textures/entity/gentleman.png");
    protected AbstractGentleManRenderer(EntityRendererProvider.Context pContext, M pModel, M pInnerModel, M pOuterModel) {
