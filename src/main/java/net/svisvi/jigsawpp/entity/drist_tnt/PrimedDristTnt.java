...
public class PrimedDristTnt extends Entity implements TraceableEntity {
    private static final EntityDataAccessor<Integer> DATA_FUSE_ID;
    private static final int DEFAULT_FUSE_TIME = 80;
    @Nullable
    private LivingEntity owner;

    public PrimedDristTnt(EntityType<? extends PrimedDristTnt> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.blocksBuilding = true;
    }

    public PrimedDristTnt(Level pLevel, double pX, double pY, double pZ, @Nullable LivingEntity pOwner) {
        this(ModEntities.DRIST_TNT.get(), pLevel);
...
//        this.level().explode(this, this.getX(), this.getY(0.0625), this.getZ(), 4.0F, ExplosionInteraction.TNT);
    ...
    static {
        DATA_FUSE_ID = SynchedEntityData.defineId(PrimedDristTnt.class, EntityDataSerializers.INT);
    }
}
